...
import product_AU_img from "./img/AU TECH.png";
...
import product_EZ_img from "./img/EZ Wheel.png";
        ...
        <body>
          ...
          <div className="main">
            ...
            <Link className="link_carborn" to="/shop/product_carborn">
              <img className="product_carborn_img" src={product_carborn_img} alt="img" />
            </Link>
            <Link className="link_delta" to="/shop/product_delta">
              <img className="product_delta_img" src={product_delta_img} alt="img" />
            </Link>
            <Link className="link_freego" to="/shop/product_freego">
              <img className="product_freego_img" src={product_freego_img} alt="img" />
            </Link>
            <Link className="link_EZ" to="/shop/product_EZ">
              <img className="product_EZ_img" src={product_EZ_img} alt="img" />
            </Link>
            <Link className="link_gyro" to="/shop/product_gyro">
              <img className="product_gyro_img" src={product_gyro_img} alt="img" />
            </Link>
            <Link className="link_nano" to="/shop/product_nano">
              <img className="product_nano_img" src={product_nano_img} alt="img" />
            </Link>
            <Link className="link_papa" to="/shop/product_papa">
              <img className="product_papa_img" src={product_papa_img} alt="img" />
            </Link>
